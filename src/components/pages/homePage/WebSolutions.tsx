  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#1F2732] bg-opacity-70">
        <div className="pt-[70px] lg:pt-32 pb-5 text-center mx-auto space-y-5 max-w-[800px]">
          <span className="smple-tex text-[15px] font-bold pb-3 mb-3 uppercase text-primary relative">
            Who We Are
          </span>
          <h2 className="text-[2.2rem] font-extrabold text-white tracking-[-0.2px] pb-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="bg-white px-5 py">
                ...
                <AccordionContent className="text-lg p-6 pt-0">
                  ...
                  and outstaffing developers. Our goal is to deliver
                  high-quality solutions quickly and efficiently, tailored to
              ...
              <AccordionItem value="item-2" className="bg-white px-5 py">
                ...
                <AccordionContent className="text-lg p-6 pt-0">
                  We typically deliver MVPs within 2 to 3 months, depending on
                  the complexity and requirements of the project. Our
                  streamlined process ensures that you receive a fully
                  functional product quickly, allowing you to enter the market
                  with confidence.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3" className="bg-white px-5 py">
                ...
                <AccordionContent className="text-lg p-6 pt-0">
                  ...
                  offer flexible service packages that can be tailored to fit
                  your specific requirements. Whether you need a full-stack
                  development team or just a few key features, we can adjust our
